...
<button type="button" id="Button2" onclick="switchVisible2();">Manage Frontdesk</button>
                 
<button type="button" id="Button4" onclick="switchVisible3();">Manage prices</button>
                 
<button type="button" id="Button5" onclick="switchVisible5();">Manage Rooms</button>

<button type="button" id="Button3" onclick="switchVisible4();">Show feedbacks</button><br>
...
$result = mysqli_query($con,"SELECT id,fname,lname,email,address FROM frontdisk");
...
$result = mysqli_query($con,"SELECT cusid,date,feedback FROM feedback");
...
$result = mysqli_query($con,"SELECT room_id,user_id,checkin,checkout FROM bookedroom");
