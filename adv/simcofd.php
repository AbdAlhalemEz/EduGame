    ...
    <div class="container-fluid">
        <div class="row">
         ...
         $cser=mysqli_connect("localhost","root","","simcore"); //database connectivity
                       $resname=mysqli_query($cser,"select fname,lname from frontdisk where id=$id1");
      ...
      echo  "<a href='tablefd.php?id=$id1' target='_blank' style='color: antiquewhite'> Front Desk Panel</a>"
            ...
            ?> </li>
                 ...
                 padding: 8px;"> Welcome Front Desk
                        ...
                        $cser=mysqli_connect("localhost","root","","simcore"); //database connectivity
                       $resname=mysqli_query($cser,"select fname from frontdisk where id=$id1");
